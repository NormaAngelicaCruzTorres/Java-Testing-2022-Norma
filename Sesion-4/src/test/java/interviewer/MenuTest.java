...
public class MenuTest {
    ...
    public void addNewInterviewer() {
        final String interviewerName = "Interviewer julian";
        final String interviewerLastName = "Interviewer cruz";
        final String interviewerEmail = "Interviewer julia.cruz@acenture.com";
        ...
        Validate.isElementDisplayed(interviewerEmail.lenght);
    }
